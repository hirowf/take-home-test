...
@Component({
  selector: 'check-todos',
  standalone: true,
  template: `
    <div
      class="flex flex-col justify-center items-center self-stretch py-16 pb-6 gap-2"
    >
      <svg
        width="56"
        height="56"
